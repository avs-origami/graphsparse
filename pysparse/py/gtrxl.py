##! Implementation of GTrXL, transformer model for reinforcement learning.
##! Based off https://github.com/dhruvramani/Transformers-RL
...
class StableTransformerXL(torch.nn.Module):
    ...
    def forward(self, inputs: torch.Tensor, memory=None):
        """
        + Arguments
        ...
        # attn_weights = self.attention_pool(layer_out)
        # layer_out = torch.sum(layer_out * attn_weights, dim=0)
